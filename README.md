...
| 🔄 **Auto refresh** — on open (cached data shown first, then silent refresh), every 60 s while open, every 5 min in background | 🔄 **自动刷新**——打开先显示缓存再静默更新、打开期间每 60 s、后台每 5 min |
